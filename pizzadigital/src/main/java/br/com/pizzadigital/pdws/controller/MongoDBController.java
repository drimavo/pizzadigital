...
public class MongoDBController {
	...
	//private static final String MONGODB_BASE          = "apppizza";
	//private static final String MONGODB_BASE_USUARIO  = "alves";
	//private static final String MONGODB_BASE_SENHA    = "wasp0503";
	//private static final String MONGODB_BASE_ENDERECO = "ds227555.mlab.com";
	//private static final String MONGODB_BASE_PORTA    = "27555";
	//------------------------------------------------------------------
