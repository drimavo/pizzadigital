 ...
 * 
 * all() ----> Retornará Produtos os registros do Banco de Dados MongoDB
...
public class ProdutoService implements CRUD<Produto> {
	...
	//----------------------------------------------------------------
	private static final String MONGODB_BASE_COLLECTION = "produtos";
	private final MongoCollection<BasicDBObject> mongoCollection;
	//----------------------------------------------------------------
	public ProdutoService(MongoDatabase mongoDatabase) {
	...
	public List<Produto> all() {
		...
		while(mongoCursor.hasNext()) {
			produtos.add(new Produto(mongoCursor.next()));
		}
	...
	public boolean upd(String json) {
		...
		basicDBObject2.put("titulo", 		basicDBObject1.getString("titulo"));
		basicDBObject2.put("descricao", 		basicDBObject1.getString("descricao"));
		basicDBObject2.put("finalizada", 	basicDBObject1.getBoolean("finalizada"));
