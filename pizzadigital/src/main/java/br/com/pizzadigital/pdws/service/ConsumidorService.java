...
import br.com.pizzadigital.pdws.model.Consumidor;
...
public class ConsumidorService implements CRUD<Consumidor> {

	//----------------------------------------------------------------
	private static final String MONGODB_BASE_COLLECTION = "consumidores";
	private final MongoCollection<BasicDBObject> mongoCollection;
	//----------------------------------------------------------------
	public ConsumidorService(MongoDatabase mongoDatabase) {
	...
	public List<Consumidor> all() {
		...
		while(mongoCursor.hasNext()) {
			consumidores.add(new Consumidor(mongoCursor.next()));
		}
